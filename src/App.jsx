...
useEffect(() => {
  const interval = setInterval(() => {
    ...
    setBulma2Image(prevImage => 
      prevImage === 'bulma2' ? 'bulma3' : 'bulma2'
    );
...
const bulmaHabla = () => {
  ...
  return (
    ...
    <img className='ElJardinDelH' src="https://eljardindelh.netlify.app/capaz.jpg" alt="El Jardin Del H" />
      ...
      <div className='Bulmay18'  alt="Bulma y Numero 18 van de compras" >s</div>
      ...
      <video className='ElVideo' src='/pesa.mp4' autoPlay controls ></video>
      ...
      <div className={bulma2Image}  alt="Bulma FanArt" ></div>
